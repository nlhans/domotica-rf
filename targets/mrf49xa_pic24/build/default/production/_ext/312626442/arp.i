...
# 15 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/arp.h"
...
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/arp.h" 2
...
# 3 "../../src/ipstack/arp.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ethdefs.h" 1
# 4 "../../src/ipstack/arp.c" 2
...
void arpBuildPacket(UI08_t* senderMac, UI08_t* senderIp, UI08_t* targetMac, UI08_t* targetIp, bool_t reply)
{
    ...
    arp.htype = ( (( 1 & 0xFF00) >> 8) | ((1 & 0xFF) << 8));
    arp.ptype = ( (( 0x0800 & 0xFF00) >> 8) | ((0x0800 & 0xFF) << 8));
    arp.hlen = 6;
    arp.plen = 4;
    arp.oper = ( (( ((reply) ? 2 : 1) & 0xFF00) >> 8) | ((((reply) ? 2 : 1) & 0xFF) << 8));

    memcpy(arp.sha, senderMac, 6);
    memcpy(arp.spa, senderIp, 4);
    memcpy(arp.tha, targetMac, 6);
    memcpy(arp.tpa, targetIp, 4);

    memcpy(arp.frame.dstMac, onesMac, 6);
    memcpy(arp.frame.srcMac, thisMac, 6);
    arp.frame.type = ( (( ProtocolARP & 0xFF00) >> 8) | ((ProtocolARP & 0xFF) << 8));
...
void arpProcessPacket(EthernetFrame_t* frame, bool_t* handled)
{
    ...
    if (frame -> type == 0x0806)
    {
        *handled = TRUE;
        ...
        arp->htype = ( (( arp->htype & 0xFF00) >> 8) | ((arp->htype & 0xFF) << 8));
        arp->ptype = ( (( arp->ptype & 0xFF00) >> 8) | ((arp->ptype & 0xFF) << 8));
        arp->oper = ( (( arp->oper & 0xFF00) >> 8) | ((arp->oper & 0xFF) << 8));
