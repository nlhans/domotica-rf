...
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/icpm.h" 2
...
# 17 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/icpm.h" 2
...
# 2 "../../src/ipstack/icmp.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ipv4.h" 1
# 3 "../../src/ipstack/icmp.c" 2
...
# 4 "../../src/ipstack/icmp.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/bsp/uart.h" 1
# 5 "../../src/ipstack/icmp.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ethdefs.h" 1
# 6 "../../src/ipstack/icmp.c" 2
...
void icmpHandlePacket (EthernetIpv4_t* header, bool_t* handled)
{
    ...
    if (header->header.protocol == 1)
    {
        *handled = TRUE;
        ...
        if (packet->icmp.type == 8 && packet->icmp.code == 0)
        {
            packet->icmp.type = 0;
            packet->icmp.crc = 0;
            packet->icmp.crc = ( (( ipv4Crc( (UI08_t*) (&packet->icmp), header->header.length - sizeof(EthernetIpv4Header_t)) & 0xFF00) >> 8) | ((ipv4Crc( (UI08_t*) (&packet->icmp), header->header.length - sizeof(EthernetIpv4Header_t)) & 0xFF) << 8));
