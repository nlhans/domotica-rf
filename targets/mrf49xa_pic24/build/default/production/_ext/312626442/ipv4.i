...
# 5 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ethdefs.h" 2
...
Ipv4PacketHandlerInfo_t Ipv4Handlers[3];
...
void ipv4HandlePacket(EthernetFrame_t* frame, bool_t* handled)
{
    ...
    if (frame->type == 0x0800)
    {
        *handled = TRUE;
        ...
        ipv4Header->header.length = ( (( ipv4Header->header.length & 0xFF00) >> 8) | ((ipv4Header->header.length & 0xFF) << 8));
...
void ipv4TxReplyPacket(EthernetIpv4_t* ipv4Packet, UI08_t totalSize)
{
    ...
    ipv4Packet->frame.type = ( (( ipv4Packet->frame.type & 0xFF00) >> 8) | ((ipv4Packet->frame.type & 0xFF) << 8));
    ipv4Packet->header.length = ( (( ipv4Packet->header.length & 0xFF00) >> 8) | ((ipv4Packet->header.length & 0xFF) << 8));
    ipv4Packet->header.crc = ( (( ipv4Crc((UI08_t*)(&ipv4Packet->header), 4*ipv4Packet->header.ihl ) & 0xFF00) >> 8) | ((ipv4Crc((UI08_t*)(&ipv4Packet->header), 4*ipv4Packet->header.ihl ) & 0xFF) << 8));
...
void ipv4TxPacket(UI08_t* dstIp, UI08_t protocol, EthernetIpv4_t *ipv4Packet, UI16_t size)
{
    ...
    ipv4Packet->frame.type = ( (( ProtocolIPv4 & 0xFF00) >> 8) | ((ProtocolIPv4 & 0xFF) << 8));
    ...
    ipv4Packet->header.length = ( (( size & 0xFF00) >> 8) | ((size & 0xFF) << 8));
    ipv4Packet->header.ID = ( (( 0x1234 & 0xFF00) >> 8) | ((0x1234 & 0xFF) << 8));
    ipv4Packet->header.flags = 0;
