...
# 1 "<command-line>"
# 1 "../../src/ipstack/tcp.c"
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/tcp.h" 1
# 15 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/tcp.h"
...
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/tcp.h" 2
...
# 17 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/tcp.h" 2
...
# 3 "../../src/ipstack/tcp.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ipv4.h" 1
# 4 "../../src/ipstack/tcp.c" 2
...
# 6 "../../src/ipstack/tcp.c" 2

TcpListener_t tcpListeners[4];
TcpConnection_t tcpConnections[8];
...
void tcpPacketHandler(EthernetIpv4_t* ipv4, bool_t* done)
{
    ...
    {
        packet->tcp.portSource = ( (( packet->tcp.portSource & 0xFF00) >> 8) | ((packet->tcp.portSource & 0xFF) << 8));
        packet->tcp.portDestination = ( (( packet->tcp.portDestination & 0xFF00) >> 8) | ((packet->tcp.portDestination & 0xFF) << 8));
        packet->tcp.flags.data = ( (( packet->tcp.flags.data & 0xFF00) >> 8) | ((packet->tcp.flags.data & 0xFF) << 8));
        packet->tcp.length = ( (( packet->tcp.length & 0xFF00) >> 8) | ((packet->tcp.length & 0xFF) << 8));
        sequenceNumber = ( ((packet->tcp.sequenceNumber & 0xFF000000) >> 24) | ((packet->tcp.sequenceNumber & 0x00FF0000) >> 8) | ((packet->tcp.sequenceNumber & 0x0000FF00) << 8) | ((packet->tcp.sequenceNumber & 0x000000FF) << 24) );
        acknowledgeNumber = ( ((packet->tcp.acknowledgement & 0xFF000000) >> 24) | ((packet->tcp.acknowledgement & 0x00FF0000) >> 8) | ((packet->tcp.acknowledgement & 0x0000FF00) << 8) | ((packet->tcp.acknowledgement & 0x000000FF) << 24) );
...
UI16_t tcpCrc(TcpPacket_t* packet, UI08_t* data, UI16_t size)
{
    ...
    while (b < size/2)
    {
        sum += ( (( dataUI16[b] & 0xFF00) >> 8) | ((dataUI16[b] & 0xFF) << 8));
        b += 1;
        counts++;
...
void tcpTxReplyPacket(UI16_t dataSize, TcpFlags_t flags, TcpPacket_t* packet, TcpConnection_t* connection)
{
    ...
    packet->tcp.portDestination = ( (( connection->remotePort & 0xFF00) >> 8) | ((connection->remotePort & 0xFF) << 8));
    packet->tcp.portSource = ( (( connection->listener->localPort & 0xFF00) >> 8) | ((connection->listener->localPort & 0xFF) << 8));
    packet->tcp.sequenceNumber = ( ((packet->tcp.sequenceNumber & 0xFF000000) >> 24) | ((packet->tcp.sequenceNumber & 0x00FF0000) >> 8) | ((packet->tcp.sequenceNumber & 0x0000FF00) << 8) | ((packet->tcp.sequenceNumber & 0x000000FF) << 24) );
    packet->tcp.acknowledgement = ( ((packet->tcp.acknowledgement & 0xFF000000) >> 24) | ((packet->tcp.acknowledgement & 0x00FF0000) >> 8) | ((packet->tcp.acknowledgement & 0x0000FF00) << 8) | ((packet->tcp.acknowledgement & 0x000000FF) << 24) );
    packet->tcp.length = ( (( packet->tcp.length & 0xFF00) >> 8) | ((packet->tcp.length & 0xFF) << 8));
    packet->tcp.flags.data = ( (( flags.data & 0xFF00) >> 8) | ((flags.data & 0xFF) << 8));
    packet->tcp.crc = 0;
    packet->tcp.crc = ipv4Crc((UI08_t*)&(packet->ipv4.header.sourceIp), dataSize + 8) - dataSize - 6;
    asm volatile("nop");;
    packet->tcp.crc = ( (( packet->tcp.crc & 0xFF00) >> 8) | ((packet->tcp.crc & 0xFF) << 8));
...
void tcpTxPacket(UI08_t* data, UI16_t dataSize, TcpFlags_t flags, TcpConnection_t* connection)
{
    ...
    packet->tcp.sequenceNumber = ( ((packet->tcp.sequenceNumber & 0xFF000000) >> 24) | ((packet->tcp.sequenceNumber & 0x00FF0000) >> 8) | ((packet->tcp.sequenceNumber & 0x0000FF00) << 8) | ((packet->tcp.sequenceNumber & 0x000000FF) << 24) );
    packet->tcp.acknowledgement = ( ((packet->tcp.acknowledgement & 0xFF000000) >> 24) | ((packet->tcp.acknowledgement & 0x00FF0000) >> 8) | ((packet->tcp.acknowledgement & 0x0000FF00) << 8) | ((packet->tcp.acknowledgement & 0x000000FF) << 24) );
    packet->tcp.length = ( (( 1400 & 0xFF00) >> 8) | ((1400 & 0xFF) << 8));
    packet->tcp.flags.data = ( (( flags.data & 0xFF00) >> 8) | ((flags.data & 0xFF) << 8));
    packet->tcp.crc = 0;
    packet->tcp.crc = ipv4Crc((UI08_t*)&(packet->ipv4.header.sourceIp), dataSize + 8+1) - dataSize - 6;
