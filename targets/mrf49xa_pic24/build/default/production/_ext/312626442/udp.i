...
# 15 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/udp.h"
...
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/udp.h" 2
...
# 2 "../../src/ipstack/udp.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ipv4.h" 1
# 3 "../../src/ipstack/udp.c" 2
...
UDPSocketHandlerInfo_t handlers[8];
...
void udpFirePacket(UDPPacket_t* packet)
{
    ...
    while (i < 8 && !done)
    {
        if(handlers[i].port == packet->udp.portDestination)
        {
...
void udpHandlePacket (EthernetIpv4_t* ipv4, bool_t* handled)
{
    ...
    if (ipv4->header.protocol == Ipv4UDP)
    {
        *handled = TRUE;
        ...
        packet->udp.portSource = ( (( packet->udp.portSource & 0xFF00) >> 8) | ((packet->udp.portSource & 0xFF) << 8));
        packet->udp.portDestination = ( (( packet->udp.portDestination & 0xFF00) >> 8) | ((packet->udp.portDestination & 0xFF) << 8));
        packet->udp.length = ( (( packet->udp.length & 0xFF00) >> 8) | ((packet->udp.length & 0xFF) << 8));
...
void udpTxPacket(UDPPacket_t* packet, UI16_t size, UI08_t* ip, UI16_t port)
{
    ...
    packet->udp.length = ( (( size & 0xFF00) >> 8) | ((size & 0xFF) << 8));
    packet->udp.portDestination = ( (( port & 0xFF00) >> 8) | ((port & 0xFF) << 8));
    packet->udp.portSource = ( (( port & 0xFF00) >> 8) | ((port & 0xFF) << 8));
    packet->udp.crc = 0;
