...
# 11 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ntp.h"
...
# 12 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ntp.h" 2
...
void ntpRequest(UI08_t* ip)
{
    ...
    ntpRequestPacket.ntp.flags = 0b11100011;
...
void ntpHandlePacket(UDPPacket_t* udp, bool_t* handled)
{
    *handled = TRUE;
    ...
    {
        ntpTimestamp = ( ((((NTPPacket_t*)udp)->ntp.stampTransmit[0] & 0xFF000000) >> 24) | ((((NTPPacket_t*)udp)->ntp.stampTransmit[0] & 0x00FF0000) >> 8) | ((((NTPPacket_t*)udp)->ntp.stampTransmit[0] & 0x0000FF00) << 8) | ((((NTPPacket_t*)udp)->ntp.stampTransmit[0] & 0x000000FF) << 24) ) - 2208988800;
        asm volatile("nop");;
    }
}
