# 1 "../../src/devices/enc28j60.c"
# 1 "C:\\Projects\\Firmware\\MRF49XA\\Library\\targets\\mrf49xa_pic24//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../src/devices/enc28j60.c"

# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/bsp/spi.h" 1
...
# 5 "C:/Projects/Firmware/MRF49XA/Library/inc/bsp/spi.h" 2
...
# 3 "../../src/devices/enc28j60.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/bsp/uart.h" 1
# 4 "../../src/devices/enc28j60.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/enc28j60.h" 1
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/enc28j60.h"
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ethdefs.h" 1
...
# 17 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/enc28j60.h" 2
...
# 40 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/enc28j60.h"
...
typedef enum enc28j60Registers_e
{
    ...
    EIE = (0x1B | 0x00) | 0x80,
    EIR = (0x1C | 0x00) | 0x80,
    ESTAT = (0x1D | 0x00) | 0x80,
    ECON2 = (0x1E | 0x00) | 0x80,
    ECON1 = (0x1F | 0x00) | 0x80,

}enc28j60Registers_t;
# 214 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/enc28j60.h"
...
# 5 "../../src/devices/enc28j60.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/udp.h" 1
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/udp.h"
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ipv4.h" 1
# 16 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ipv4.h"
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ethdefs.h" 1
# 17 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/ipv4.h" 2
...
# 17 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/udp.h" 2
...
# 6 "../../src/devices/enc28j60.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/arp.h" 1
# 18 "C:/Projects/Firmware/MRF49XA/Library/inc/ipstack/arp.h"
...
extern const UI08_t onesMac[6];
# 7 "../../src/devices/enc28j60.c" 2
# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/insight.h" 1



# 1 "C:/Projects/Firmware/MRF49XA/Library/inc/stddefs.h" 1
# 5 "C:/Projects/Firmware/MRF49XA/Library/inc/insight.h" 2
# 72 "C:/Projects/Firmware/MRF49XA/Library/inc/insight.h"
typedef enum insightMessages_e
{
    INSIGHT_NULLMSG, INSIGHT_INIT_INSIGHT, INSIGHT_23LC1024_INIT, INSIGHT_23LC1024_READ, INSIGHT_23LC1024_WRITE, INSIGHT_ENC28J60_READ_REG, INSIGHT_ENC28J60_WRITE_REG, INSIGHT_ENC28J60_BITSET_REG, INSIGHT_ENC28J60_BITCLR_REG, INSIGHT_ENC28J60_RX, INSIGHT_ENC28J60_TX, INSIGHT_ENC624J600_SPI, INSIGHT_ENC624J600_REG, INSIGHT_ENC624J600_MAC, INSIGHT_ENC624J600_PACKETS, INSIGHT_ENC624J600_RX, INSIGHT_ENC624J600_RX_PKT, INSIGHT_ENC624J600_TX, INSIGHT_ENC624J600_TX_PKT, INSIGHT_ARP_WHOHAS, INSIGHT_ARP_ANNOUNCE, INSIGHT_ICMP_PINGPONG, INSIGHT_IPV4_TX_REPLY, INSIGHT_IPV4_TX, INSIGHT_IPV4_RX, INSIGHT_UDP_TX, INSIGHT_UDP_RX, INSIGHT_NTP_TIME, INSIGHT_NTP_REQUEST, INSIGHT_TCP_RX, INSIGHT_TCP_RX_FLAGS, INSIGHT_TCP_RX_CONNECTION, INSIGHT_TCP_RX_RESERVING, INSIGHT_TCP_LISTEN, INSIGHT_TCP_PICKED, INSIGHT_TCP_MATCHED, INSIGHT_TCP_NO_CONNECTION, INSIGHT_TCP_RX_DATA, INSIGHT_DATASIZE, INSIGHT_HTTP_RX_HEADERS, INSIGHT_TCP_TX, INSIGHT_TCP_TX_REPLY,
    INSIGHT_MESSAGES
} insightMessages_t;
...
static EthernetPacketHandlerInfo_t handlers[2];
...
void enc28j60WriteUint8(UI08_t reg, UI08_t value)
{
    asm volatile("bclr PORTC, #8\n");;
    (spiTxByte(1, WCR | (reg & 0x1F)));
    (spiTxByte(1, value));
    asm volatile("bset PORTC, #8\n");;
...
void enc28j60WriteUint16(UI08_t reg, UI16_t value)
{
    asm volatile("bclr PORTC, #8\n");;
    (spiTxByte(1, WCR | (reg & 0x1F)));
    (spiTxByte(1, value & 0x00FF));
    (spiTxByte(1, (value & 0xFF00) >> 8));
    asm volatile("bset PORTC, #8\n");;
...
{
    UI16_t d = 0;
    d = enc28j60ReadUint8(reg);
    d = d | (enc28j60ReadUint8(reg+1) << 8);
...
void enc28j60SetBank(enc28j60Register_t reg)
{
    ...
    {
        asm volatile("bclr PORTC, #8\n");;
        (spiTxByte(1, BFC | (ECON1 & 0x1F)));
        (spiTxByte(1, 0b00000011));
        asm volatile("bset PORTC, #8\n");;
    }
    ...
    {
        asm volatile("bclr PORTC, #8\n");;
        (spiTxByte(1, BFS | (ECON1 & 0x1F)));
        (spiTxByte(1, currentBank));
        asm volatile("bset PORTC, #8\n");;
    }
...
void enc28j60WriteData(UI16_t memAddress, UI08_t* bf, UI16_t size)
{
    ...
    asm volatile("bclr PORTC, #8\n");;
    (spiTxByte(1, WBM | 0x1A));
    spiTxRxBytes(1, bf, (0), size);
    asm volatile("bset PORTC, #8\n");;
...
void enc28j60ReadData(UI16_t memAddress, UI08_t* bf, UI16_t size)
{
    ...
    asm volatile("bclr PORTC, #8\n");;
    (spiTxByte(1, RBM | 0x1A));
    spiTxRxBytes(1, (0), bf, size);
    asm volatile("bset PORTC, #8\n");;

}
# 171 "../../src/devices/enc28j60.c"
UI08_t enc28j60ReadRegisterUint8(UI08_t address)
{
...
UI16_t enc28j60ReadPhyRegisterUint16(UI08_t address)
{
    ...
    enc28j60BitSetRegisterUint8(MICMD, 0x01);
    while(enc28j60ReadMacUint8(MISTAT) & 0x1);
    enc28j60BitClrRegisterUint8(MICMD, 0x01);

    asm volatile("bclr PORTC, #8\n");;
    (spiTxByte(1, RCR | (MIRDL & 0x1F)));
    (spiTxByte(1, 0));
    temp = spiRxByte(1);
...
void enc28j60Initialize(UI08_t* mac)
{
    ...
    while ((enc28j60ReadRegisterUint8(ESTAT) & 0x01) == 0);

    enc28j60WritePhyRegisterUint16(PHLCON, 0b0000011101000010);


    enc28j60WriteRegisterUint16(ERXSTL, 0);
    enc28j60WriteRegisterUint16(ERXNDL, 4095);
    enc28j60WriteRegisterUint16(ERXRDPTL, 0);


    enc28j60WriteRegisterUint16(ETXSTL, 4096);
    enc28j60WriteRegisterUint16(ETXNDL, 8191);
# 342 "../../src/devices/enc28j60.c"
    enc28j60WriteRegisterUint8(MACON1, 0b00001101);

    enc28j60WriteRegisterUint8(MACON3, 0b11110110);
    enc28j60WriteRegisterUint8(MACON4, 0b01000000);
    enc28j60WriteRegisterUint16(MAMXFLL, 1518);
    enc28j60WriteRegisterUint8(MABBIPG, 0x12);
    enc28j60WriteRegisterUint16(MAIPGL, 0xC12);
    ...
    enc28j60WritePhyRegisterUint16(PHCON2, 0b000000100000000);
    enc28j60BitSetRegisterUint8(ECON1, 0b00000100);
...
void enc28j60TxFrame(EthernetFrame_t* packet, UI16_t length)
{
    ...
    while ((enc28j60ReadRegisterUint8(ECON1) & 0x8) != 0)
    {
    ...
    enc28j60WriteRegisterUint16(EWRPTL, 4096);


    enc28j60WriteRegisterUint16(ETXNDL, 4096 + length);


    enc28j60WriteData(4096, &controlByte, 1);
    enc28j60WriteData(4096 +1, (UI08_t*)packet, length);


    enc28j60BitClrRegisterUint8(EIR, 0b00001010);
    enc28j60BitSetRegisterUint8(ECON1, 0b00001000);
...
# 448 "../../src/devices/enc28j60.c"
        if (((receiveStatus >> 4) & 0x1) == 0)
        {
            ...
            enc28j60ReadData(dataPtr + 4, packet, packetSize+2-4);

            frame = (EthernetFrame_t*) (packet+2);
            frame-> type = ( (( frame->type & 0xFF00) >> 8) | ((frame->type & 0xFF) << 8));
        ...
        enc28j60BitSetRegisterUint8(ECON2, 0b01000000);
