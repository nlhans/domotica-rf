...
# 5 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/SST26VF032.h" 2
...
# 6 "C:/Projects/Firmware/MRF49XA/Library/inc/devices/SST26VF032.h" 2
...
UI08_t* FlashReadId(void)
{
    ...
    sqiTxByte(2, 0xAF);
    flashChipId[0] = sqiRxByte(2);
    flashChipId[1] = sqiRxByte(2);
    flashChipId[2] = sqiRxByte(2);
    FlashCsSet(0, 1);
...
UI08_t FlashRxByte(UI32_t addr)
{
    ...
    spiTxByte(2, 0x03);
    spiTxByte(2, (addr >> 16) & 0xFF);
    spiTxByte(2, (addr >> 8) & 0xFF);
    spiTxByte(2, (addr & 0xFF));
    UI08_t data = spiRxByte(2);
    FlashCsSet(addr, 1);
...
void FlashTxBytes(UI32_t addr, UI08_t *bf, UI16_t size)
{
    ...
    sqiTxByte(2, addr >> 16);
    sqiTxByte(2, addr >> 8);
    sqiTxByte(2, addr & 0xFF);

    sqiTxRxBytes(2, bf, (0), size);
